...
// There is a ramp up before reaching this max period.
export const WATCH_PERIOD_INTEXT = 600 * 1000;
...
export const POPUP_INTEXT_WIDTH = 380;
export const POPUP_INTEXT_HEIGHT = 140;

// Phone status depending on last seen seconds
export const PHONE_STATUS_ONLINE = 100;
export const PHONE_STATUS_IDLE = 3600;

// Text status depending on last seen seconds
export const TEXT_STATUS_ONLINE = 100;
export const TEXT_STATUS_IDLE = 10800;
